defmodule Albedo.TUI.TerminalTest do
  ...
  describe "ANSI escape code functions" do
    test "clear_screen returns proper escape sequence" do
      import ExUnit.CaptureIO

      output = capture_io(fn -> Terminal.clear_screen() end)
      assert output == "\e[2J\e[H"
    end

    test "move_cursor returns proper escape sequence" do
      import ExUnit.CaptureIO

      output = capture_io(fn -> Terminal.move_cursor(5, 10) end)
