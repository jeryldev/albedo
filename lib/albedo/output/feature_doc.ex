defmodule Albedo.Output.FeatureDoc do
  @moduledoc """
  Generates the final FEATURE.md document from project data.
  """

  alias Albedo.Output.Markdown

  @doc """
  Generate a complete FEATURE.md document from project state.
  """
  def generate(project_state) do
    sections = [
      generate_header(project_state),
      generate_executive_summary(project_state),
      generate_domain_context(project_state),
      generate_scope(project_state),
      Markdown.horizontal_rule(),
      generate_technical_overview(project_state),
      Markdown.horizontal_rule(),
      generate_tickets(project_state),
      Markdown.horizontal_rule(),
      generate_dependency_graph(project_state),
      generate_implementation_order(project_state),
      generate_risk_summary(project_state),
      generate_effort_estimate(project_state),
      Markdown.horizontal_rule(),
      generate_appendix(project_state)
    ]
